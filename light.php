			...
			<div class="panel panel-primary">
				...
				<div id="gce" class="panel-collapse collapse" style="max-height: 512px;overflow-y: scroll;">
					<div class="panel-body" style="position: relative;">
						...
						<p>
							Az oldal a <?php echo "<a href='https://btk.elte.hu/tanev-rendje'>"; ?> https://btk.elte.hu/tanev-rendje.</a> oldalt használja, hogy beállítsa a szorgalmi időszak kezdetét.<br>
